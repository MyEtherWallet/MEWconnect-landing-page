      ...
      items: [
        ...
        },
        {
          ...
          list: [
            ...
            },
            {
              ...
              description:
                "This is the single most important piece of information about your wallet. These 12 words will decide the future of your funds. Do not lose them, and do not screenshot them. Pass the seed word check test."
            },
            {
              text: "You’re done!",
        ...
        },
        {
          ...
          list: [
            ...
            {
              text:
                'Find a desktop computer. Head to the <a href="https://mcbeta.myetherwallet.com/">MEW site</a>.',
              description:
        ...
        },
        {
          ...
          list: [
            ...
            {
              text:
                'Connect to the <a href="https://mcbeta.myetherwallet.com/">MEW site</a>, as shown above.',
              description: ""
            },
            {
              text: "Follow the process of a regular transaction.",
              description:
                'Fill in the ‘To Address’, ‘Amount to Send’, and ‘Gas Limit’ fields. If you have any questions, refer to our article on <a href="https://kb.myetherwallet.com/send/how-to-send-transaction.html">How to Send a Transaction</a>.'
            },
            {
          ...
          list: [
            {
              ...
              description:
                "These can be found at the bottom of the wallet screen."
            },
            {
